...
import com.example.user.live500px.view.SlidingTabLayout;
...
public class MoreInfoFragment extends Fragment {
    ...
    public static MoreInfoFragment newInstance(PhotoDao dao) {
    ...
    private void initInstances(View rootView, Bundle savedInstanceState) {
        ...
        slidingTabLayout = (SlidingTabLayout) rootView.findViewById(
                R.id.slidingTabLayout);
    ...
    private Intent getSharedIntent(){
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT,"Extra Texr");
        return intent;
    }
